...
public class FarmerOrdersAdapter extends FirebaseRecyclerAdapter<FarmerMyOrderModel, FarmerOrdersAdapter.myViewHolder> {
    ...
    public FarmerOrdersAdapter(@NonNull FirebaseRecyclerOptions<FarmerMyOrderModel> options,Context context) {
        super(options);
