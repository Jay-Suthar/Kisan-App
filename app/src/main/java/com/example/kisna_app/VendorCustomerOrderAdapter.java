...
public class VendorCustomerOrderAdapter extends FirebaseRecyclerAdapter<FarmerMyOrderModel, VendorCustomerOrderAdapter.myViewHolder> {
    ...
    public VendorCustomerOrderAdapter(@NonNull FirebaseRecyclerOptions<FarmerMyOrderModel> options,Context context) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull FarmerMyOrderModel model) {
        ...
        holder.btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseDatabase.getInstance().getReference().child("User").child(model.getParent_vendor()).child("Farmer_Orders").child(cur_user1).updateChildren(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
