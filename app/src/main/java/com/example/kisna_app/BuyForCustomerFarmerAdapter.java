...
public class BuyForCustomerFarmerAdapter extends FirebaseRecyclerAdapter<VendorModel, BuyForCustomerFarmerAdapter.myViewHolder> {
    ...
    public BuyForCustomerFarmerAdapter(@NonNull FirebaseRecyclerOptions<VendorModel> options,Context context) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull VendorModel model) {
        ...
        holder.detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, farmer_product_details.class);
                intent.putExtra("key",cur_user1);
                intent.putExtra("main_key","ALL_SEEDS_MANURE_FERTILIZERS_EQUIPMENT");
